...
public class RentMessageActivity extends AppCompatActivity {
                ...
                if (item.getItemId() == R.id.btnOptions) {
                    ...
                    if (!alertDialog.isShowing()) {
                        if (status.equals("pending")) {
                            ...
                            MaterialButton btnSetPrice = dialogView.findViewById(R.id.btnSetPrice);
                            ...
                            final View dialogView = LayoutInflater.from(RentMessageActivity.this).inflate(R.layout.dialog_rent_options_confirmed_transport, null);
                            alertDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
                            alertDialog.setCancelable(true);
                            alertDialog.setView(dialogView);

                            TextView rentReferenceNo = dialogView.findViewById(R.id.rentReferenceNo);
                            MaterialButton btnConfirmPayment = dialogView.findViewById(R.id.btnConfirmPayment);
    ...
    private void initList() {
        ...
        adapterRentChatMessageRV = new AdapterRentChatMessageRV(options, getIntent().getStringExtra("transport_id"));
                    ...
                    rentalsReference.document(getIntent().getStringExtra("rental_id"))
                            ...
                            .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                ...
                                public void onComplete(@NonNull Task<DocumentReference> task) {
                                    if (task.isSuccessful()) {
                                        fetchToken(getIntent().getStringExtra("user_id"), getIntent().getStringExtra("name"), message);
                                        HashMap<String, Object> hashMap = new HashMap<>();
                                        hashMap.put("timestamp", timestamp);
                                        rentalsReference.document(getIntent().getStringExtra("rental_id"))
                                                .update(hashMap)
