...
import com.opustech.bookvan.ui.user.PartnersActivity;
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.btnGenerateQR) {
                    Intent intent = new Intent(DashboardActivity.this, GenerateQRActivity.class);
                    startActivity(intent);
                }
                ...
                if (item.getItemId() == R.id.btnSchedules) {
                    Intent intent = new Intent(DashboardActivity.this, SystemSchedulesActivity.class);
                    startActivity(intent);
                }
                if (item.getItemId() == R.id.btnPartners) {
                    Intent intent = new Intent(DashboardActivity.this, PartnersActivity.class);
                    startActivity(intent);
                }
