...
public class UserProfileActivity extends AppCompatActivity {
    ...
    private void startUpdateInfoDialog() {
        ...
        if (!alertDialog.isShowing()) {
            final View dialogView = LayoutInflater.from(UserProfileActivity.this).inflate(R.layout.dialog_edit_profile, null);
                ...
                .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(UserProfileActivity.this, "Image upload failed. Please try again.", Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
                        }
                    }
                });
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Glide.with(UserProfileActivity.this)
                                    .load(imageUrl)
                                    .into(profilePhoto);
                            Toast.makeText(UserProfileActivity.this, "Image upload success.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
