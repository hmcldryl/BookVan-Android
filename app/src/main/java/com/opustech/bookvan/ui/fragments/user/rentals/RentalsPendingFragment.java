...
import com.opustech.bookvan.adapters.user.AdapterRentalPendingUserListRV;
...
public class RentalsPendingFragment extends Fragment {
    ...
    private AdapterRentalPendingUserListRV adapterRentalPendingUserListRV;
    ...
    private void populateList(View root, String uid) {
        ...
        adapterRentalPendingUserListRV = new AdapterRentalPendingUserListRV(options, getUserName(), getActivity());
        ...
        adapterRentalPendingUserListRV.setHasStableIds(true);
        ...
        rentalList.setAdapter(adapterRentalPendingUserListRV);

        adapterRentalPendingUserListRV.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
            public void onItemRangeInserted(int positionStart, int itemCount) {
                rentalList.smoothScrollToPosition(adapterRentalPendingUserListRV.getItemCount());
            }
        });
    }
    ...
    public void onStart() {
        super.onStart();
        adapterRentalPendingUserListRV.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        adapterRentalPendingUserListRV.stopListening();
    }
}