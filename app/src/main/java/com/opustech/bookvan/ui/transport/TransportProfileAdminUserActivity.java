...
import com.opustech.bookvan.ui.transport.TransportProfileAdminUserActivity;
import com.opustech.bookvan.ui.user.ProfileActivity;
...
public class TransportProfileAdminUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transport_profile_admin_user);
    ...
    private void startUpdateInfoDialog() {
        final AlertDialog.Builder builder = new AlertDialog.Builder(TransportProfileAdminUserActivity.this);
        final AlertDialog alertDialog = builder.create();
        if (!alertDialog.isShowing()) {
            final View dialogView = LayoutInflater.from(TransportProfileAdminUserActivity.this).inflate(R.layout.dialog_edit_profile, null);
            ...
            btnConfirm.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    final ACProgressFlower dialog = new ACProgressFlower.Builder(TransportProfileAdminUserActivity.this)
                        ...
                        usersReference.document(firebaseAuth.getCurrentUser().getUid())
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        dialog.dismiss();
                                        alertDialog.dismiss();
                                        Toast.makeText(TransportProfileAdminUserActivity.this, "Success.", Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                                    ...
                                    if (value.exists()) {
                                        ...
                                        if (photo_url != null) {
                                            if (!photo_url.isEmpty()) {
                                                Glide.with(TransportProfileAdminUserActivity.this)
                                                        .load(photo_url)
                                                        .into(profilePhoto);
                                            }
                                        }
                ...
                .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(TransportProfileAdminUserActivity.this, "Image upload failed. Please try again.", Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
                        }
                    }
                });
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Glide.with(TransportProfileAdminUserActivity.this)
                                    .load(imageUrl)
                                    .into(profilePhoto);
                            Toast.makeText(TransportProfileAdminUserActivity.this, "Image upload success.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
