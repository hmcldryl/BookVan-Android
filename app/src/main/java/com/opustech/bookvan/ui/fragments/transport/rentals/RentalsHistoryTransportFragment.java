...
import com.opustech.bookvan.adapters.transport.AdapterRentalHistoryTransportListRV;
import com.opustech.bookvan.model.Rental;

import java.util.Arrays;

public class RentalsHistoryTransportFragment extends Fragment {
    ...
    private AdapterRentalHistoryTransportListRV adapterRentalHistoryTransportListRV;
    ...
    private void populateList(View root, String transport_uid) {
        ...
        adapterRentalHistoryTransportListRV = new AdapterRentalHistoryTransportListRV(options, getTransportName(), getActivity());
        ...
        adapterRentalHistoryTransportListRV.setHasStableIds(true);
        ...
        rentalList.setAdapter(adapterRentalHistoryTransportListRV);

        adapterRentalHistoryTransportListRV.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
            public void onItemRangeInserted(int positionStart, int itemCount) {
                rentalList.smoothScrollToPosition(adapterRentalHistoryTransportListRV.getItemCount());
            }
        });
    }
    ...
    public void onStart() {
        super.onStart();
        adapterRentalHistoryTransportListRV.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        adapterRentalHistoryTransportListRV.stopListening();
    }
}