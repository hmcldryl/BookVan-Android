                ...
                .addSnapshotListener(this, new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        if (value != null) {
                            ...
                            badgeDrawable.setBackgroundColor(ContextCompat.getColor(BookingActivity.this, R.color.colorBadgeBackground));
                            badgeDrawable.setBadgeTextColor(ContextCompat.getColor(BookingActivity.this, R.color.white));
