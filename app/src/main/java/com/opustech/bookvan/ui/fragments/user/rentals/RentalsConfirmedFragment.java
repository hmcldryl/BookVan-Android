...
import com.opustech.bookvan.adapters.user.AdapterRentalConfirmedUserListRV;
...
public class RentalsConfirmedFragment extends Fragment {
    ...
    private AdapterRentalConfirmedUserListRV adapterRentalConfirmedTransportListRV;
    ...
    private void populateList(View root, String uid) {
        ...
        adapterRentalConfirmedTransportListRV = new AdapterRentalConfirmedUserListRV(options, getName(), getActivity());
