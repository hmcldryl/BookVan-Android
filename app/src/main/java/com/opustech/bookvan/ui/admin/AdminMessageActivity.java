...
public class AdminMessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(AdminMessageActivity.this);
        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(AdminMessageActivity.this, manager.getOrientation());
