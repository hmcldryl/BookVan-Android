...
import com.opustech.bookvan.adapters.admin.AdapterRentalCancelledAdminListRV;
import com.opustech.bookvan.model.Rental;

public class RentalsCancelledFragment extends Fragment {
    ...
    private AdapterRentalCancelledAdminListRV adapterRentalCancelledAdminListRV;
    ...
    private void populateList(View root) {
        Query query = rentalsReference.whereEqualTo("status", "cancelled")
        ...
        adapterRentalCancelledAdminListRV = new AdapterRentalCancelledAdminListRV(options, getActivity());
        ...
        rentalList.setAdapter(adapterRentalCancelledAdminListRV);

        adapterRentalCancelledAdminListRV.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
            public void onItemRangeInserted(int positionStart, int itemCount) {
                rentalList.smoothScrollToPosition(adapterRentalCancelledAdminListRV.getItemCount());
            }
        });
    }
    ...
    public void onStart() {
        super.onStart();
        adapterRentalCancelledAdminListRV.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        adapterRentalCancelledAdminListRV.stopListening();
    }
}