package com.opustech.bookvan.ui.adapters.user;
...
public class AdapterMessageChatRV extends FirestoreRecyclerAdapter<ChatMessage, AdapterMessageChatRV.ChatMessageHolder> {
    ...
    public AdapterMessageChatRV(@NonNull FirestoreRecyclerOptions<ChatMessage> options) {
        super(options);
    }
