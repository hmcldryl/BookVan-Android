...
public class TransportAdminRentalsActivity extends AppCompatActivity {
                ...
                .addSnapshotListener(this, new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        if (value != null) {
                            ...
                            badgeDrawable.setBackgroundColor(ContextCompat.getColor(TransportAdminRentalsActivity.this, R.color.colorBadgeBackground));
                            badgeDrawable.setBadgeTextColor(ContextCompat.getColor(TransportAdminRentalsActivity.this, R.color.white));
