...
public class TransportAdminEditCompanyProfileActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(TransportAdminEditCompanyProfileActivity.this, "Company profile updated successfully.", Toast.LENGTH_SHORT).show();
                            onBackPressed();
                            finish();
                        }
                    }
                ...
                .addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(TransportAdminEditCompanyProfileActivity.this, "Image upload failed. Please try again.", Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
                        }
                    }
                });
        ...
        partnersReference.document(getIntent().getStringExtra("uid"))
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            dialog.dismiss();
                            Glide.with(TransportAdminEditCompanyProfileActivity.this)
                                    .load(imageUrl)
                                    .into(companyPhoto);
                            Toast.makeText(TransportAdminEditCompanyProfileActivity.this, "Image upload success.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
