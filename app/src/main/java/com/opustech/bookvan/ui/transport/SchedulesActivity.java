...
public class SchedulesActivity extends AppCompatActivity {
                                                            ...
                                                            .addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                                                ...
                                                                public void onComplete(@NonNull Task<DocumentReference> task) {
                                                                    if (task.isSuccessful()) {
                                                                        dialog.dismiss();
                                                                        enableInput();
                                                                        Toast.makeText(SchedulesActivity.this, "Success.", Toast.LENGTH_SHORT).show();
                                                                    }
                                                                }
                                                            });
                                                }
    ...
    private void initializeTimePickerDepart() {
        ...
        scheduleRouteTimeQueue.getEditText().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new TimePickerDialog(SchedulesActivity.this, time,
    ...
    private void populateRouteCategoryList() {
        ...
        ArrayAdapter<String> routeFromArrayAdapter = new ArrayAdapter<>(SchedulesActivity.this, R.layout.support_simple_spinner_dropdown_item, routeFromArray);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            adapterTransportDropdownSystemSchedule = new AdapterTransportDropdownSystemSchedule(SchedulesActivity.this, routeArray);
                            ...
                            dialog.dismiss();
                            Toast.makeText(SchedulesActivity.this, "NotificationData loading failed.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
