...
import com.opustech.bookvan.adapters.admin.AdapterRentalHistoryAdminListRV;
...
public class RentalsHistoryFragment extends Fragment {
    ...
    private AdapterRentalHistoryAdminListRV adapterRentalHistoryAdminListRV;
    ...
    private void updateUi() {
        rentalsReference.whereIn("status", Arrays.asList("done", "cancelled"))
    ...
    private void populateList(View root) {
        Query query = rentalsReference.whereIn("status", Arrays.asList("done", "cancelled"))
        ...
        adapterRentalHistoryAdminListRV = new AdapterRentalHistoryAdminListRV(options, getActivity());
        ...
        adapterRentalHistoryAdminListRV.setHasStableIds(true);
        ...
        rentalList.setAdapter(adapterRentalHistoryAdminListRV);

        adapterRentalHistoryAdminListRV.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
            public void onItemRangeInserted(int positionStart, int itemCount) {
                rentalList.smoothScrollToPosition(adapterRentalHistoryAdminListRV.getItemCount());
            }
        });
    }
    ...
    public void onStart() {
        super.onStart();
        adapterRentalHistoryAdminListRV.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        adapterRentalHistoryAdminListRV.stopListening();
    }
}