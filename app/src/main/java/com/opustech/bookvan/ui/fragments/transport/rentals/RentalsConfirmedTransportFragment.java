...
import com.opustech.bookvan.adapters.transport.AdapterRentalConfirmedTransportListRV;
import com.opustech.bookvan.model.Rental;

public class RentalsConfirmedTransportFragment extends Fragment {
    ...
    private AdapterRentalConfirmedTransportListRV adapterRentalConfirmedTransportListRV;
    ...
    private void populateList(View root, String transport_uid) {
        ...
        adapterRentalConfirmedTransportListRV = new AdapterRentalConfirmedTransportListRV(options, getTransportName(), getActivity());
        ...
        adapterRentalConfirmedTransportListRV.setHasStableIds(true);
        ...
        rentalList.setAdapter(adapterRentalConfirmedTransportListRV);

        adapterRentalConfirmedTransportListRV.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
            public void onItemRangeInserted(int positionStart, int itemCount) {
                rentalList.smoothScrollToPosition(adapterRentalConfirmedTransportListRV.getItemCount());
            }
        });
    }
    ...
    public void onStart() {
        super.onStart();
        adapterRentalConfirmedTransportListRV.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        adapterRentalConfirmedTransportListRV.stopListening();
    }
}