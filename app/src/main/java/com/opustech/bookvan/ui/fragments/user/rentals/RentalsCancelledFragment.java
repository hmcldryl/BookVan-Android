...
import com.opustech.bookvan.adapters.user.AdapterRentalCancelledUserListRV;
...
public class RentalsCancelledFragment extends Fragment {
    ...
    private AdapterRentalCancelledUserListRV adapterRentalCancelledUserListRV;
    ...
    private void populateList(View root, String uid) {
        ...
        adapterRentalCancelledUserListRV = new AdapterRentalCancelledUserListRV(options, getName(), getActivity());
        ...
        adapterRentalCancelledUserListRV.setHasStableIds(true);
        ...
        rentalList.setAdapter(adapterRentalCancelledUserListRV);

        adapterRentalCancelledUserListRV.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            @Override
            public void onItemRangeInserted(int positionStart, int itemCount) {
                rentalList.smoothScrollToPosition(adapterRentalCancelledUserListRV.getItemCount());
            }
        });
    }
    ...
    public void onStart() {
        super.onStart();
        adapterRentalCancelledUserListRV.startListening();
    }

    @Override
    public void onStop() {
        super.onStop();
        adapterRentalCancelledUserListRV.stopListening();
    }
}