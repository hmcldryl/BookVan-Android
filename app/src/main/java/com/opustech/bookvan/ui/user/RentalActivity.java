                ...
                .addSnapshotListener(this, new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        if (value != null) {
                            ...
                            badgeDrawable.setBackgroundColor(ContextCompat.getColor(RentalActivity.this, R.color.colorBadgeBackground));
                            badgeDrawable.setBadgeTextColor(ContextCompat.getColor(RentalActivity.this, R.color.white));
