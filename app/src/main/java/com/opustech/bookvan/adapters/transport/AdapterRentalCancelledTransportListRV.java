...
public class AdapterRentalCancelledTransportListRV extends FirestoreRecyclerAdapter<Rental, AdapterRentalCancelledTransportListRV.RentalHolder> {
    ...
    public AdapterRentalCancelledTransportListRV(@NonNull FirestoreRecyclerOptions<Rental> options, String name, Context context) {
        super(options);
        this.name = name;
    ...
    public RentalHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rental_transport_cancelled_item_layout, parent, false);
