...
public class AdapterBookingCancelledTransportListRV extends FirestoreRecyclerAdapter<Booking, AdapterBookingCancelledTransportListRV.BookingHolder> {
    ...
    public AdapterBookingCancelledTransportListRV(@NonNull FirestoreRecyclerOptions<Booking> options, Context context) {
        super(options);
    ...
    public BookingHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.booking_transport_cancelled_item_layout, parent, false);
