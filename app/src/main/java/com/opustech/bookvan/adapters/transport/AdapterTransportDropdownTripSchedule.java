...
public class AdapterTransportDropdownTripSchedule extends ArrayAdapter<Schedule> {
    public AdapterTransportDropdownTripSchedule(@NonNull Context context, ArrayList<Schedule> scheduleArrayList) {
