...
public class AdapterRentalHistoryUserListRV extends FirestoreRecyclerAdapter<Rental, AdapterRentalHistoryUserListRV.RentalHolder> {
    ...
    public AdapterRentalHistoryUserListRV(@NonNull FirestoreRecyclerOptions<Rental> options, String name, Context context) {
        super(options);
        this.name = name;
    ...
    public RentalHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rental_user_history_item_layout, parent, false);
