...
public class AdapterRentalCancelledAdminListRV extends FirestoreRecyclerAdapter<Rental, AdapterRentalCancelledAdminListRV.RentalHolder> {
    ...
    public AdapterRentalCancelledAdminListRV(@NonNull FirestoreRecyclerOptions<Rental> options, Context context) {
        super(options);
    ...
    public RentalHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rental_admin_cancelled_item_layout, parent, false);
