...
public class AdapterRentalCancelledUserListRV extends FirestoreRecyclerAdapter<Rental, AdapterRentalCancelledUserListRV.RentalHolder> {
    ...
    public AdapterRentalCancelledUserListRV(@NonNull FirestoreRecyclerOptions<Rental> options, String name, Context context) {
        super(options);
        this.name = name;
    ...
    public RentalHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.rental_user_cancelled_item_layout, parent, false);
