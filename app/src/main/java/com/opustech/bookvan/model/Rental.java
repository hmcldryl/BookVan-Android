...
public class Rental {
    ...
    public Rental(String uid, String rent_type, String name, String location_pickup, String location_dropoff, String contact_number, String destination, String schedule_start_date, String schedule_end_date, String timestamp) {
        this.uid = uid;
